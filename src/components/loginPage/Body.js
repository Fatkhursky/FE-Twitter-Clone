  ...
  return (
    <div>
      <div className="box-login">
          ...
          <h1 className="tes">Sign in to Twitter</h1>
          <div className="btns">
            <div style={{cursor:"pointer"}} className="s-gogle">
              <svg
                width="40"
                height="41"
                viewBox="0 0 40 41"
              ...
              <span className="s-gog">Sign in with Google</span>
            </div>
            <div style={{cursor:"pointer"}} className="s-apple">
              <svg
                width="40"
                height="41"
                viewBox="0 0 77 94"
              ...
              <span className="s-app">Sign in with Apple</span>
            </div>
            <h1 className="or"><span>Or</span></h1>
            <input
              className="input"
              type="text"
              placeholder="Phone, email or username"
            />
            <button style={{cursor:"pointer"}} className="next">Next</button>
            <button style={{cursor:"pointer"}} className="f-pass">Forgot Password?</button>
            <h1 className="signup">
              Don't have account? <span style={{cursor:"pointer"}}>&nbsp;Sign up</span>
            </h1>
          </div>
