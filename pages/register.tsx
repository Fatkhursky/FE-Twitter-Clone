              ...
              <div style={{ backgroundColor: '' }} className="loginpage__signup__main">
                <div className="loginpage__signup__form">
                  <div className="loginpage__signup__title1">
                    <h1 className="loginpage__signup__title">Set your password</h1>
                  </div>
                  ...
                  {/* <label htmlFor="" className="loginpage__signup__inp">
                    ...
                    />
                    <span className="loginpage__signup__label">Password</span>
                    <svg
                  onClick={isPassNull}
                  viewBox="0 0 24 24"
                  aria-hidden="true"
              ...
              <div className="loginpage__signup__footer__step3">
                ...
                >
                  ...
                  >
                    <h2>Verify phone</h2>
                    <p style={{width: ''}}>
                      We'll text your verification code to 089765566543. Standard SMS fees
                      may apply.
                    </p>
                    <button
                      style={{
